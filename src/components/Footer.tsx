      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          >
            ...
            <span className="font-body text-sm">@boatdirect</span>
          </a>

          <div className="w-16 h-px bg-primary-foreground/20" />

          <div>
            <p className="font-display text-lg text-primary-foreground mb-2">Boat Direct</p>
            <p className="font-body text-xs text-primary-foreground/40">
              © {new Date().getFullYear()} Boat Direct. {t("footer.rights")}
            </p>
          </div>
        </div>
      </div>
