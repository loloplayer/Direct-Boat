...
const fleet = [
  {
    ...
    cabins: 4,
    durations: [
      { label: "2h", priceFrom: "709", originalPrice: "788" },
      { label: "3h", priceFrom: "945", originalPrice: "1050" },
      { label: "4h", priceFrom: "1087", originalPrice: "1208" },
      { label: "6h", priceFrom: "1654", originalPrice: "1838" },
      { label: "8h", priceFrom: "2127", originalPrice: "2363" },
    ],
    ticketFrom: "76.50",
    ticketOriginal: "85",
